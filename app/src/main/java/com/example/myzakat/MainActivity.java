...
public class MainActivity extends AppCompatActivity {
    ...
    public void Clicklistener(){
        ...
        submit.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                if (etweightvalue.getText().toString().isEmpty() && etgoldvalue.getText().toString().isEmpty()) {
                ...
                if (radioKeep.isChecked()) {
                    ...
                    totalGold.setText("  Total Value of Gold: RM" + String.valueOf(tValue));
                    zakatPay.setText("  Zakat Payable : RM" + String.valueOf(zakatpay));
                    totalZakat.setText("  Total Zakat      : RM" + String.valueOf(tZakat));
                }
